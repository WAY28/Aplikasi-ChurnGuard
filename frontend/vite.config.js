...
export default defineConfig({
  plugins: [
    react(),
    // Cuma dipakai halaman Admin (lihat src/styles/admin-tailwind.css) --
    // preflight/reset Tailwind sengaja TIDAK diimpor supaya tidak mengubah
    // tampilan halaman lain yang sudah pakai CSS biasa (lihat komentar di
    // file itu).
    tailwindcss(),
    VitePWA({
